            ...
            public void onClick(View v) {
                ...
                if (index == -1) {
                    if (String.valueOf(name_text.getText()).equals("")) {
                        ...
                        if(start_c.get(Calendar.YEAR)>end_c.get(Calendar.YEAR)||(start_c.get(Calendar.YEAR)==end_c.get(Calendar.YEAR)&&start_c.get(Calendar.MONTH)>end_c.get(Calendar.MONTH))
                                ||(start_c.get(Calendar.YEAR)==end_c.get(Calendar.YEAR)&&start_c.get(Calendar.MONTH)==end_c.get(Calendar.MONTH)&&start_c.get(Calendar.DAY_OF_MONTH)>end_c.get(Calendar.DAY_OF_MONTH))){
